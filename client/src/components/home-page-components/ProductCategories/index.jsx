    ...
    <section className="categories-section">
      <div className="categories-container">
        ...
        >
          ...
          <p>Исследуйте тысячи готовых решений для разработки</p>
        </motion.div>

        <div className="categories-grid">
          {categories.map((category, index) => (
            <Link style={{color: "white", textDecoration: "none"}} href={category.link} key={index}>
              <motion.div
